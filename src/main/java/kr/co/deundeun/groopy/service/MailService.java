...
public class MailService {
    ...
    private String buildRegisterClub(Club club, User user) {
        ...
        body.append("<p>").append(club.getCategoryType()).append("</p>");
        body.append("<h3> 소개글 </h3>");
        body.append("<p>").append(club.getIntroduction()).append("</p>");
        body.append("<h2> 승인링크 </h2>");
        body.append(appProperties.getServerUrl()).append("/clubs/");
        body.append(club.getId()).append("/approve");
    ...
    private String buildApplicantUser(User user) {
        ...
        applicantInfo.append("<li> 이름 : ").append(user.getName()).append("</li>");
        applicantInfo.append("<li> 닉네임 : ").append(user.getNickname()).append("</li>");
        applicantInfo.append("<li> 번호 : ").append(user.getPhoneNumber()).append("</li>");
        applicantInfo.append("<li> 이메일 : ").append(user.getEmail()).append("</li>");
        applicantInfo.append("</ul> ");
    ...
    private String buildApplicantClub(Club club) {
        ...
        applicantInfo.append("<ul> ");
        applicantInfo.append("<li> 동아리 이름 : ").append(club.getClubName()).append("</li>");
        applicantInfo.append("<li> 기수 : ").append(club.getGeneration()).append("</li>");
        applicantInfo.append("</ul> ");
        return applicantInfo.toString();
    }
}
